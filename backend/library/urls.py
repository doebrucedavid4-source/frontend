...
from .views import (
    ...
    CsrfView,
    LivreViewSet,
    LivreExemplaireCreateView,
    LivreImageUploadView,
    LoginView,
    LogoutView,
    MeEmpruntsView,
    MeEmpruntCreateView,
    MeNotificationsView,
    MeNotificationsCountUnreadView,
    MeNotificationsMarkReadView,
    MePenalitesView,
    MeReservationsView,
    MeView,
    PublicStatsView,
...
urlpatterns = [
    ...
    path("books/<int:livre_id>/upload-image/", LivreImageUploadView.as_view()),
    ...
    path("me/notifications/unread-count/", MeNotificationsCountUnreadView.as_view()),
    path("me/notifications/mark-read/", MeNotificationsMarkReadView.as_view()),
    path("books/<int:livre_id>/exemplaires/", LivreExemplaireCreateView.as_view()),
